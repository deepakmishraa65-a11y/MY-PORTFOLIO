...
export default function Marquee() {
  return (
    <div className="relative overflow-hidden border-y border-white/10 py-6 bg-gradient-to-r from-[rgb(var(--c2-rgb)/0.5)] to-[rgb(var(--c1-rgb)/0.5)]">
      ...
      <div className="flex w-max animate-marquee gap-8">
        {[...items, ...items].map((item, i) => (
          ...
          >
            {item}
            <span className="text-[rgb(var(--c1-rgb))]">✦</span>
          </span>
        ))}
      </div>
    </div>
